 ...
 * 
 * token=requestToken.substring(7); try {
 * username=this.jwtTokenHelper.getUsernameFromToken(token); }
 * catch(IllegalArgumentException e) {
 * System.out.println("Unable to get jwt token"); } catch(ExpiredJwtException e)
 * { System.out.println("Jwt token has been expired"); }
 * catch(MalformedJwtException e) { System.out.println("invalid jwt"); } } else
 * {
 * 
 * 
 * System.out.println("Jwt token dont begin with Bearer"); }
 * 
 * if(username!=null &&
 ...
 * 
 * }else { System.out.println("Invalid Jwt Token"); } } else {
 ...
 * 
 * 
 * import java.io.IOException; import java.util.Enumeration; import
 * java.util.Iterator;
 * 
 * 
 * 
 ...
 * // 1. get token
 * 
 * String requestToken = request.getHeader("Authorization"); Enumeration<String>
 * headerNames = request.getHeaderNames();
 * 
 * while(headerNames.hasMoreElements()) {
 * System.out.println(headerNames.nextElement()); } // Bearer 2352523sdgsg
 * 
 ...
 * 
 * 
 * try { username = this.jwtTokenHelper.getUsernameFromToken(token); } catch
 * (IllegalArgumentException e) { System.out.println("Unable to get Jwt token");
 * } catch (ExpiredJwtException e) {
 * System.out.println("Jwt token has expired"); } catch (MalformedJwtException
 * e) { System.out.println("invalid jwt");
 * 
 * }
 * 
 ...
 * 
 * if (this.jwtTokenHelper.validateToken(token, userDetails)) { // shi chal rha
 * hai // authentication karna hai
 * 
 * UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = new
